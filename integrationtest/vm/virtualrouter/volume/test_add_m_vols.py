...
def test():
    '''
    Test Description:
        Create 1 VR VM and create 24 Data Volumes. Check if 24 Data Volumes could be attached to VM at the same time. 
    Resource required:
        2 VM will be created. 24*10M data volumes will be created. 
    '''
