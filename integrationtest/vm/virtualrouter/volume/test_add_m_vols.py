...
def test():
    '''
    Test Description:
        Create 1 VR VM and create 23 Data Volumes. Check if 23 Data Volumes could be attached to VM at the same time. 
    Resource required:
        2 VM will be created. 23*10M data volumes will be created. 
    '''
    ...
    vm.check()
    test_util.test_dsc('Test attach/detach 23 volumes operations.')
    for i in range(vol_num):
    ...
    test_util.test_dsc('Redo attach/detach 23 volumes operations.')
