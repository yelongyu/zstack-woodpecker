...
Test IPsec creation when ikeEncryptionAlgorithm is aes-256
...
def test():
    ...
    #ipsec1 = ipsec_ops.create_ipsec_connection('ipsec1', pri_l3_uuid1, vip2.get_vip().ip, '123456', vip1.get_vip().uuid, [os.environ['secondZStackCidrs']], ike_encryption_algorithm="aes-256")
    ipsec1 = ipsec_ops.create_ipsec_connection('ipsec1', pri_l3_uuid1, vip2.get_vip().ip, '123456', vip1.get_vip().uuid, second_zstack_cidrs, ike_encryption_algorithm="aes-256")
