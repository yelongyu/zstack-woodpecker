...
def test():
    ...
    multi_iso.vm1.stop()
    multi_iso.create_cdrom(iso_uuid=multi_iso.iso_uuids[0])
    ...
    multi_iso.vm1.stop()
    multi_iso.create_cdrom(iso_uuid=multi_iso.iso_uuids[1])

    multi_iso.vm1.start()
    multi_iso.vm1.check()
    multi_iso.check_cdroms_number(2)
    multi_iso.check_vm_systag(multi_iso.iso_uuids[1])

    multi_iso.vm1.stop()
    multi_iso.create_cdrom(iso_uuid=multi_iso.iso_uuids[2])

    multi_iso.vm1.start()
    multi_iso.vm1.check()
    multi_iso.check_cdroms_number(3)
    multi_iso.check_vm_systag(multi_iso.iso_uuids[2])

    test_lib.lib_robot_cleanup(test_obj_dict)
    test_util.test_pass('Create VM CDROM Test Success')
