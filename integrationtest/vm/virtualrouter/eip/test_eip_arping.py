...
def test():
    ...
    ret_val, ret_out = commands.getstatusoutput("cat /var/log/zstack/zstack-kvmagent.log|grep arping")
    if ret_out:
        test_util.test_fail('arping error occurs. Please check /var/log/zstack/zstack-kvmagent.log')
    else:
        test_util.test_pass('Check eip arping Success')
