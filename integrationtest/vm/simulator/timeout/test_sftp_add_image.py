...
case_flavor = dict(download_default=         dict(agent_url=DOWNLOAD_IMAGE_PATH, agent_action=1),
                   download_default_6min=    dict(agent_url=DOWNLOAD_IMAGE_PATH, agent_action=2),
                   )
