...
case_flavor = dict(download_image_default=         dict(agent_url=DOWNLOAD_IMAGE_PATH, agent_action=1),
                   download_image_default_6min=    dict(agent_url=DOWNLOAD_IMAGE_PATH, agent_action=2),
                   )
