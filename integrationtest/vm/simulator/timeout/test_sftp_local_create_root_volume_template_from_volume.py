...
case_flavor = dict(create_tempate_default=                    dict(agent_url=CREATE_TEMPLATE_FROM_VOLUME, agent_action=1),
                   upload_to_sftp_default=                    dict(agent_url=UPLOAD_BIT_PATH, agent_action=1),
                   create_tempate_default_default_6min=       dict(agent_url=CREATE_TEMPLATE_FROM_VOLUME, agent_action=2),
                   upload_to_sftp_default_6min=               dict(agent_url=UPLOAD_BIT_PATH, agent_action=2),
                   )
...
def test():
    ...
    if agent_url == CREATE_TEMPLATE_FROM_VOLUME:
