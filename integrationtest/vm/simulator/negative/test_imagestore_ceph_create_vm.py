...
db_tables_white_list = ['VmInstanceSequenceNumberVO', 'TaskProgressVO', 'RootVolumeUsageVO', 'ImageCacheVO', 'SecurityGroupFailureHostVO', 'ResourceVO', 'AccountResourceRefVO']
...
'''
    ...
    test_stub.print_table('AccountResourceRefVO')
