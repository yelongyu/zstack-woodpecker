'''
1.create private ipv6 address with Network cidr
2.check dhcp ipv6 address
...
ip_Version = [4, 6]
networkcidr = "CDCD:910A:2222:5498:8475:1111:3900:2020/120"

dhcp_ip_for_private = "CDCD:910A:2222:5498:8475:1111:3900:2020"
dhcp_system_tags = [
...
def test():
    ...
    private_network.add_ipv6_by_networkcidr(
        ip_range_name,
        networkcidr,
        dhcp_system_tags)
