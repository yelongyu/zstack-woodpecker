...
def test():
    ...
    prj_adm_systemtag = 'projectAdminOfProjectUuid::%s' % prj_uuid
    iam2_ops.add_roles_to_iam2_virtual_id([platform_admin_role_uuid], virtual_id_uuid, system_tags=[prj_adm_systemtag])
