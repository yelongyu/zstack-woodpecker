'''
test iam2 project admin basic operations
@author: zhaohao.chen
'''
import os
...
import project_admin_attr_statements as prj_adm_statement
...
statement =  prj_adm_statement.STATEMENT
...
def test():
    ...
    role_name = 'prj_admin_customize'
    role_uuid = iam2_ops.create_role(role_name, statements=[statement]).uuid
    ...
    volume_option.set_name('data_volume_iam2_prj_adm')
    ...
    vm_creation_option.set_name('vm_iam2_prj_adm')
    ...
    #l2 = net_ops.create_l2_novlan('l2_iam2_prj_adm', 'eth0', zone_uuid, session_uuid=session_uuid)
    #l2 = net_ops.create_l2_vlan('l2_iam2_prj_adm', 'eth0', zone_uuid, 1234, session_uuid=session_uuid)
