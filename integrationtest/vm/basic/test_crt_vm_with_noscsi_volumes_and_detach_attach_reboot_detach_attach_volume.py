...
New Integration Test for create vm with no-scsi 6 volumes and detach 6 volumes and reboot vm and attach one volumes .

@author: ye.tian 2018-12-13
'''
...
def test():
    ...
    test_util.test_pass('Create VM with no-scsi volumes and detach/attach and after reboot and detach/attach Test Success')
