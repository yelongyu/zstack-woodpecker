...
def test():
    ...
    vm.check()
    vm_capabilities = vm_ops.get_vm_capabilities(vm.get_vm().uuid)
    if vm_capabilities.capabilities.Reimage:
    ...
    vm2.check()
    vm2_capabilities = vm_ops.get_vm_capabilities(vm2.get_vm().uuid)
    if not vm2_capabilities.capabilities.Reimage:
