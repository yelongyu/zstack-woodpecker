...
Test about monitor trigger on one host cpu use ratio in five minutes
...
def test():
    ...
    host = hosts[0]
    duration = 300
    expression = "host.cpu.util{cpu=2,type=\"used\"}>90.7"
    ...
    for i in range(5):test_stub.run_cpu_load(ssh_cmd, 2, 1)
