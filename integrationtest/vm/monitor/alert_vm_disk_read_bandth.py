...
Test about monitor trigger on vm disk reading bandwidth in one minute
...
def test():
    ...
    #duration = 60
    duration = 50
    #expression = "vm.disk.io{type=\"bandwidth\", direction=\"read\"} > 300.0"
    expression = "vm.disk.io{type=\"bandwidth\", direction=\"read\"} > 100.0"
