...
Test about monitor trigger on vm disk reading iops in one minute
...
def test():
    ...
    #duration = 60
    duration = 50
    #expression = "vm.disk.io{type=\"iops\", direction=\"read\"} > 300.0"
    expression = "vm.disk.io{type=\"iops\", direction=\"read\"} > 100.0"
