...
Test about monitor trigger on vm disk writing bandwidth in five minutes
...
def test():
    ...
    duration = 300
    #expression = "vm.disk.io{type=\"bandwidth\", direction=\"write\"} > 250.0"
    expression = "vm.disk.io{type=\"bandwidth\", direction=\"write\"} > 50.0"
