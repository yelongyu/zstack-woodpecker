...
Running:['vm3']
Stopped:['vm2', 'vm4']
Enadbled:['vm2-backup3', 'vm1-backup4', 'auto-volume1-backup4', 'vm4-backup6', 'image2', 'vm3-image3']
attached:[]
Detached:['auto-volume1']
Deleted:['volume3', 'volume4', 'auto-volume1-backup2', 'vm2-backup1']
Expunged:['vm1', 'volume2', 'image1']
Ha:['vm3']
Group:
	vm_backup2:['vm2-backup3']---vm2@
	vm_backup3:['vm1-backup4', 'auto-volume1-backup4']---vm1@auto-volume1
