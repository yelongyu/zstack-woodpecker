...
def path():
    ...
    return dict(initial_formation="template5", checking_point=1, faild_point=100000, path_list=[
		...
		[TestAction.create_vm_by_image, 'image4', 'iso', 'vm4', 'cluster=cluster1'],
...
Running:['vm2', 'vm4']
Stopped:['vm3', 'vm1']
Enadbled:['volume1-backup1', 'vm2-backup3', 'vm1-backup4', 'vm2-image3', 'image4']
attached:['volume2']
Detached:['volume1', 'volume4']
Deleted:['vm2-backup2', 'image2']
