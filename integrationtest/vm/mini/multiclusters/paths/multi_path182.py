...
def path():
    ...
    return dict(initial_formation="template5", checking_point=1, faild_point=100000, path_list=[
		...
		[TestAction.delete_volume_backup, 'volume2-backup7'],
])
...
Running:[]
Stopped:['vm1', 'vm4', 'vm3']
Enadbled:['volume3-backup2', 'vm1-backup3', 'volume3-backup3', 'vm1-backup5', 'volume3-backup5', 'vm1-image2']
attached:['volume3', 'volume2']
Detached:['volume4']
Deleted:['vm1-backup1', 'volume2-backup7']
