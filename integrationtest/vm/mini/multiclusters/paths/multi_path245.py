...
Running:['vm3', 'vm1']
Stopped:['vm2', 'vm4']
Enadbled:['volume1-backup1', 'vm2-backup3', 'vm2-backup5', 'volume5-backup5', 'vm3-image2', 'image3', 'vm1-image4']
attached:['volume5']
Detached:['volume2', 'volume3']
Deleted:['volume1', 'vm2-backup2', 'volume5-backup4']
Expunged:['volume4', 'image1']
Ha:['vm1']
Group:
	vm_backup2:['vm2-backup5', 'volume5-backup5']---vm2@volume5
