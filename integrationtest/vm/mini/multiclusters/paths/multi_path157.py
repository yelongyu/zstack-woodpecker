...
Running:['vm4']
Stopped:['vm1']
Enadbled:['volume1-backup1', 'volume3-backup3', 'volume1-backup4']
attached:[]
Detached:['volume3', 'volume4', 'volume1', 'volume5']
Deleted:['vm1-backup2', 'vm1-backup5']
Expunged:['vm2', 'vm3', 'volume2', 'image1']
Ha:[]
Group:
'''