...
def path():
    ...
    return dict(initial_formation="template5", checking_point=1, faild_point=100000, path_list=[
		...
		[TestAction.create_vm_by_image, 'image1', 'iso', 'vm3', 'cluster=cluster1'],
		[TestAction.poweroff_only, 'cluster=cluster1'],
...
Running:[]
Stopped:['vm1', 'vm3', 'vm4']
Enadbled:['volume1-backup4', 'image1', 'vm2-image3', 'vm3-image4']
attached:[]
Detached:['volume4', 'volume5', 'volume1']
Deleted:['vm2', 'volume3', 'vm2-backup2', 'volume2-backup3', 'volume1-backup1']
