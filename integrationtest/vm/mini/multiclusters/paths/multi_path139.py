...
def path():
    ...
    return dict(initial_formation="template5", checking_point=1, faild_point=100000, path_list=[
		...
		[TestAction.attach_volume, 'vm6', 'volume5'],
...
Enadbled:['vm1-backup1', 'volume2-backup4', 'image2']
attached:['auto-volume6', 'volume2', 'volume5']
Detached:[]
Deleted:['volume3', 'vm3-backup2', 'volume1-backup2', 'volume5-backup5']
