...
Enadbled:['vm1-backup3', 'volume1-backup3', 'vm4-backup6', 'image3']
attached:['auto-volume3']
Detached:['volume4', 'volume5', 'volume2']
Deleted:['volume2-backup2', 'volume2-backup5', 'vm1-backup1', 'image2']
Expunged:['volume1', 'vm1-image1']
Ha:[]
Group:
	vm_backup2:['vm1-backup3', 'volume1-backup3']---vm1@volume1
	vm_backup3:['vm4-backup6']---vm4@
'''