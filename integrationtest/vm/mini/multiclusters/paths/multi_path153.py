...
def path():
    ...
    return dict(initial_formation="template5", checking_point=1, faild_point=100000, path_list=[
		...
		[TestAction.create_vm_backup, 'vm6', 'vm6-backup3'],
		[TestAction.start_vm, 'vm4'],
		[TestAction.migrate_vm, 'vm4'],
		[TestAction.poweroff_only, 'cluster=cluster2'],
		[TestAction.delete_vm_backup, 'vm6-backup3'],
])
...
Running:['vm2', 'vm5', 'vm4']
Stopped:['vm3', 'vm6']
Enadbled:['image2', 'image3']
attached:['auto-volume5']
Detached:['volume1', 'volume4']
Deleted:['vm1', 'volume2', 'volume1-backup1', 'volume1-backup2', 'vm6-backup3']
