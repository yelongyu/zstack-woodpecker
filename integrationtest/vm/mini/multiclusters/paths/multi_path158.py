...
Running:['vm4', 'vm5']
Stopped:['vm1', 'vm3']
Enadbled:['volume2-backup2', 'vm1-backup3', 'volume2-backup3', 'image1', 'image3', 'vm1-image4']
attached:['volume2']
Detached:['volume1', 'volume4', 'volume5']
Deleted:['vm2', 'volume1-backup1', 'vm4-backup5']
Expunged:['volume3', 'vm1-image2']
Ha:[]
Group:
	vm_backup1:['vm1-backup3', 'volume2-backup3']---vm1@volume2
'''