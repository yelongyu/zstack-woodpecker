...
Running:[]
Stopped:['vm4', 'vm1']
Enadbled:['volume1-backup1', 'volume4-backup2', 'volume5-backup4']
attached:['volume5', 'volume6']
Detached:['volume3', 'volume2']
Deleted:['vm2', 'volume4', 'vm1-backup3', 'volume6-backup5']
Expunged:['vm3', 'volume1', 'image1']
Ha:[]
Group:
'''