...
Running:[]
Stopped:['vm5', 'vm2']
Enadbled:['volume1-backup2', 'volume4-backup3', 'volume3-backup4', 'vm2-backup5', 'volume1-backup5', 'volume4-backup5', 'image2', 'vm4-image3']
attached:['volume1', 'volume4', 'volume3']
Detached:[]
Deleted:['vm1', 'vm4', 'vm2-backup1']
Expunged:['vm3', 'volume2', 'image1']
Ha:[]
Group:
	vm_backup1:['vm2-backup5', 'volume1-backup5', 'volume4-backup5']---vm2@volume1_volume4
'''