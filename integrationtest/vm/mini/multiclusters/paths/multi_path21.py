...
def path():
    ...
    return dict(initial_formation="template5", checking_point=1, faild_point=100000, path_list=[
		...
		[TestAction.poweroff_only, 'cluster=cluster1'],
		[TestAction.delete_vm_backup, 'vm1-backup6'],
])
...
Running:['vm4', 'vm1']
Stopped:['vm3']
Enadbled:['volume1-backup1', 'image3', 'image1', 'vm3-image4']
attached:[]
Detached:['volume1', 'volume2']
Deleted:['vm2', 'vm3-backup2', 'volume2-backup2', 'vm3-backup4', 'volume2-backup4', 'vm1-backup6']
