...
Running:['vm3']
Stopped:['vm2', 'vm1']
Enadbled:['auto-volume1-backup1', 'vm1-backup4', 'auto-volume1-backup4', 'vm1-backup6', 'image2']
attached:[]
Detached:['volume2', 'volume3', 'volume4', 'volume6', 'auto-volume1']
Deleted:['vm1-backup2', 'auto-volume1-backup2']
Expunged:['volume5', 'image1']
Ha:[]
Group:
	vm_backup2:['vm1-backup6']---vm1@
	vm_backup1:['vm1-backup4', 'auto-volume1-backup4']---vm1@auto-volume1
'''