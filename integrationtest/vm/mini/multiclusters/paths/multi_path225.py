...
'''
The final status:
Running:['vm3', 'vm4', 'vm2', 'vm5', 'vm6']
Stopped:[]
Enadbled:['vm2-backup1', 'vm1-backup3', 'vm4-backup4', 'volume1-backup4']
attached:['volume1']
Detached:['volume3']
Deleted:['vm1', 'volume2-backup2', 'volume3-backup6']
Expunged:['volume2', 'image1']
Ha:[]
Group:
	vm_backup2:['vm1-backup3']---vm1@
	vm_backup3:['vm4-backup4', 'volume1-backup4']---vm4@volume1
