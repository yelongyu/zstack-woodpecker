...
def path():
    ...
    return dict(initial_formation="template5", checking_point=1, faild_point=100000, path_list=[
		...
		[TestAction.create_vm_by_image, 'image1', 'iso', 'vm6', 'cluster=cluster2'],
		[TestAction.delete_image, 'image1'],
...
Stopped:['vm3', 'vm1']
Enadbled:['volume2-backup2', 'vm4-backup4', 'vm1-backup5']
attached:[]
Detached:['volume2']
Deleted:['vm2-backup1', 'vm3-backup3', 'image1']
Expunged:['volume1', 'image2']
Ha:[]
Group:
	vm_backup2:['vm1-backup5']---vm1@
