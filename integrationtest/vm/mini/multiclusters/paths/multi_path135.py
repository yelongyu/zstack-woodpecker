...
Running:['vm1', 'vm3', 'vm4']
Stopped:['vm2', 'vm5']
Enadbled:['volume2-backup2', 'vm2-backup3', 'volume2-backup3', 'vm5-backup5']
attached:['volume2', 'auto-volume3', 'volume4']
Detached:[]
Deleted:['vm1-backup1']
...
Group:
	...
	vm_backup1:['vm2-backup3', 'volume2-backup3']---vm2@volume2
'''