...
Stopped:[]
Enadbled:['vm2-backup1', 'vm2-backup3', 'vm3-backup4', 'volume2-backup4', 'image2']
attached:['volume2']
Detached:['volume1']
Deleted:['vm1', 'volume2-backup2', 'volume2-backup6']
Expunged:['volume3', 'image1']
Ha:['vm3']
Group:
	vm_backup2:['vm2-backup3']---vm2@
	vm_backup3:['vm3-backup4', 'volume2-backup4']---vm3@volume2
