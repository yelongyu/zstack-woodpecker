...
Running:['vm3']
Stopped:['vm1']
Enadbled:['volume1-backup1', 'volume1-backup3', 'volume4-backup5', 'vm1-backup6', 'vm1-image3']
attached:[]
Detached:['volume2', 'volume1', 'volume5', 'volume4']
Deleted:['vm2', 'vm2-backup2', 'vm1-backup4', 'image2']
