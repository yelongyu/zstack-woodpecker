...
Running:['vm4', 'vm1']
Stopped:['vm3', 'vm2']
Enadbled:['volume1-backup1', 'vm1-backup3', 'vm2-backup5', 'volume1-backup5', 'vm3-image2', 'vm2-image3']
attached:['volume1', 'volume2']
Detached:[]
Deleted:['volume3', 'vm1-backup2', 'volume2-backup4']
Expunged:['volume4', 'image1']
Ha:['vm1']
Group:
	vm_backup2:['vm2-backup5', 'volume1-backup5']---vm2@volume1
