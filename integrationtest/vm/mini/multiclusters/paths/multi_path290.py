...
Running:['vm4']
Stopped:['vm2', 'vm1']
Enadbled:['auto-volume1-backup1', 'vm2-backup2', 'auto-volume1-backup3', 'vm1-backup4', 'auto-volume1-backup4', 'vm4-image2']
...
Ha:[]
Group:
	vm_backup2:['vm1-backup4', 'auto-volume1-backup4']---vm1@auto-volume1
