...
def path():
    ...
    return dict(initial_formation="template5", checking_point=1, faild_point=100000, path_list=[
		...
		[TestAction.poweroff_only, 'cluster=cluster1'],
		[TestAction.delete_volume_backup, 'auto-volume4-backup3'],
])
...
'''
The final status:
Running:['vm1', 'vm3', 'vm4', 'vm2', 'vm5', 'vm6']
Stopped:[]
Enadbled:['vm2-backup1', 'vm2-backup2', 'image2']
attached:['auto-volume4', 'volume4']
Detached:['volume1', 'volume2']
Deleted:['auto-volume4-backup3']
