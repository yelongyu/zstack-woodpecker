...
Running:['vm4']
Stopped:['vm2']
Enadbled:['volume1-backup1', 'vm3-backup4', 'vm2-backup5', 'volume3-backup5', 'vm2-image1', 'vm4-image3']
attached:['auto-volume4', 'volume3']
Detached:['volume1']
Deleted:['vm1', 'vm2-backup2', 'volume1-backup2']
Expunged:['vm3', 'volume2', 'image2']
Ha:[]
Group:
	vm_backup2:['vm3-backup4']---vm3@
	vm_backup3:['vm2-backup5', 'volume3-backup5']---vm2@volume3
'''