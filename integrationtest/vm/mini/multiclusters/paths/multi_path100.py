...
def path():
    ...
    return dict(initial_formation="template5", checking_point=1, faild_point=100000, path_list=[
		...
		[TestAction.poweroff_only, 'cluster=cluster1'],
		[TestAction.create_volume_backup, 'auto-volume6', 'auto-volume6-backup6'],
		[TestAction.delete_volume_backup, 'auto-volume6-backup6'],
])
...
The final status:
Running:['vm3', 'vm6']
Stopped:['vm1', 'vm4', 'vm2', 'vm5']
Enadbled:['vm1-backup2', 'vm3-backup3', 'volume2-backup3', 'vm2-backup5', 'image2', 'vm6-image3']
attached:['volume2', 'auto-volume6']
Detached:['volume1', 'volume3', 'volume5']
Deleted:['volume1-backup1', 'auto-volume6-backup6']
