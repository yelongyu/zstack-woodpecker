...
The final status:
Running:[]
Stopped:['vm3', 'vm1', 'vm2', 'vm4']
Enadbled:['volume1-backup3', 'vm3-backup4', 'volume1-backup5']
attached:[]
Detached:['volume1']
Deleted:['volume2', 'volume4', 'vm2-backup2', 'volume1-backup1', 'image2']
Expunged:['volume3', 'vm1-image1']
Ha:[]
Group:
