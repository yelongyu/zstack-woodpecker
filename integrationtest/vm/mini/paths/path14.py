...
def path():
    ...
    return dict(initial_formation="template5", path_list=[
        ...
        [TestAction.create_mini_vm, "vm4", 'data_volume=true', 'cpu=2', 'memory=2', 'provisiong=thin'],
        [TestAction.detach_volume, "volume1"],
        [TestAction.delete_volume, "volume1"],
        [TestAction.create_mini_vm, "vm5", 'data_volume=true', 'cpu=2', 'memory=random', 'provisiong=thin'],
        [TestAction.add_image, "image2", 'root', "http://172.20.1.28/mirror/diskimages/centos_vdbench.qcow2"],
        [TestAction.expunge_volume, "volume2"],
        [TestAction.destroy_vm, "vm2"],
        [TestAction.recover_vm, "vm2"],
        [TestAction.start_vm, "vm2"],
        [TestAction.create_volume_backup, "vm1-root", "backup4"],
