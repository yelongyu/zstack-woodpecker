...
def path():
    ...
    return dict(initial_formation="template5", path_list=[
		...
		[TestAction.batch_delete_volume_snapshot, ['vm1-root-snapshot3','volume3-snapshot7',]],
])
...
Running:[]
Stopped:['vm1']
Enadbled:['vm1-snapshot4', 'volume1-snapshot5', 'volume3-snapshot6', 'vm1-snapshot8']
attached:[]
Detached:['volume1', 'volume2', 'volume3']
Deleted:['vm1-snapshot1', 'vm1-snapshot2', 'vm1-root-snapshot3', 'volume3-snapshot7']
Expunged:[]
Ha:[]
Group:
