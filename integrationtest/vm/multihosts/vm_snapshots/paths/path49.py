...
def path():
    ...
    return dict(initial_formation="template5", path_list=[
		...
		[TestAction.delete_volume_snapshot, 'vm1-root-snapshot14'],
		TestAction.batch_delete_snapshots, ['vm1-root-snapshot1','volume2-snapshot3',],
])
...
Detached:[]
Deleted:['vm1-snapshot5', 'volume1-snapshot5', 'volume2-snapshot5', 'volume3-snapshot5', 'vm1-root-snapshot14', 'vm1-root-snapshot1', 'volume2-snapshot3']
Expunged:[]
Ha:[]
Group:
