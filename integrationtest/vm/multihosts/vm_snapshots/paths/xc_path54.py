...
Running:['vm1', 'vm2']
Stopped:[]
Enadbled:['vm1-snapshot9', 'volume1-snapshot9', 'volume2-snapshot9', 'volume3-snapshot9', 'vm2-backup1', 'volume4-backup1', 'volume1-image1', 'vm2-image2']
...
Group:
	...
	vm_backup1:['vm2-backup1', 'volume4-backup1']---vm2@volume4
'''