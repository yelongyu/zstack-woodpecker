...
def path():
    ...
    return dict(initial_formation="template5", checking_point=8, path_list=[
		...
		[TestAction.create_volume_snapshot, 'volume4', 'volume4-snapshot16'],
...
Running:['vm1', 'vm2']
Stopped:[]
Enadbled:['vm1-snapshot5', 'volume1-snapshot5', 'volume2-snapshot5', 'volume3-snapshot5', 'volume4-snapshot5', 'vm1-snapshot10', 'volume1-snapshot10', 'volume2-snapshot10', 'volume3-snapshot10', 'volume4-snapshot10', 'vm1-root-snapshot15', 'volume4-snapshot16', 'vm1-root-backup1']
