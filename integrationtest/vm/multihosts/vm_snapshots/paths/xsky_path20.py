...
Running:['vm2', 'vm1']
Stopped:[]
Enadbled:['vm1-snapshot5', 'volume1-snapshot5', 'volume3-snapshot5', 'vm1-snapshot8', 'volume1-snapshot8', 'volume3-snapshot8', 'vm2-backup1', 'volume2-backup1']
attached:['volume1', 'volume3', 'volume2']
Detached:[]
...
Group:
	...
	vm_backup1:['vm2-backup1', 'volume2-backup1']---vm2_volume2
'''