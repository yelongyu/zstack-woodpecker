...
Running:['vm1']
Stopped:[]
Enadbled:['vm1-snapshot5', 'volume2-snapshot5', 'volume3-snapshot5', 'vm1-snapshot8', 'volume2-snapshot8', 'volume3-snapshot8', 'vm1-root-snapshot11', 'vm1-backup1', 'volume1-backup1', 'volume2-backup1', 'volume3-backup1', 'vm1-backup5', 'volume2-backup5', 'volume3-backup5', 'volume3-backup8']
...
Group:
	...
	vm_backup2:['vm1-backup5', 'volume2-backup5', 'volume3-backup5']---vm1@volume2_volume3
