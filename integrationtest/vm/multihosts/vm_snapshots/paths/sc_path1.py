...
def path():
    ...
    return dict(initial_formation="template5", path_list=[
		...
		[TestAction.start_vm, 'vm1'],
		[TestAction.stop_vm, 'vm1'],
		[TestAction.use_volume_snapshot, 'vm1-root-snapshot13'],
		[TestAction.start_vm, 'vm1'],
		[TestAction.stop_vm, 'vm1'],
...
Running:['vm1']
Stopped:[]
Enadbled:['volume1-snapshot2', 'vm1-root-snapshot7', 'vm1-root-snapshot8', 'vm1-root-snapshot13']
attached:['volume1', 'volume2', 'volume3']
Detached:[]
Deleted:['vm1-snapshot3', 'volume1-snapshot3', 'volume2-snapshot3', 'volume3-snapshot3', 'volume1-snapshot1', 'vm1-snapshot9', 'volume1-snapshot9', 'volume2-snapshot9', 'volume3-snapshot9']
Expunged:[]
Ha:[]
Group:
'''