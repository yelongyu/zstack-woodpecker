...
Running:['vm1']
Stopped:[]
Enadbled:['vm1-snapshot8', 'volume2-snapshot8', 'volume3-snapshot8', 'vm1-root-backup1', 'vm1-image1']
attached:['volume2', 'volume3']
Detached:[]
Deleted:['volume1', 'vm1-snapshot1', 'volume1-snapshot1', 'volume2-snapshot1', 'volume3-snapshot1', 'vm1-snapshot5', 'volume2-snapshot5', 'volume3-snapshot5']
Expunged:[]
Ha:[]
Group:
