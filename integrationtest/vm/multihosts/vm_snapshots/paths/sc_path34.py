...
Running:['vm1']
Stopped:[]
Enadbled:['vm1-root-snapshot1', 'volume2-snapshot6', 'vm1-root-snapshot7', 'vm1-root-snapshot8', 'vm1-snapshot10', 'volume1-snapshot10', 'volume2-snapshot10', 'volume3-snapshot10', 'volume1-snapshot14', 'vm1-backup1', 'volume1-backup1', 'volume2-backup1', 'volume3-backup1']
attached:['volume1', 'volume2', 'volume3']
Detached:[]
Deleted:['vm1-snapshot2', 'volume1-snapshot2', 'volume2-snapshot2', 'volume3-snapshot2', 'vm1-root-snapshot9']
Expunged:[]
Ha:[]
Group:
