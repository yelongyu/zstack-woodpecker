...
def path():
    ...
    return dict(initial_formation="template5", path_list=[
		...
		[TestAction.batch_delete_volume_snapshot, ['vm1-root-snapshot4','vm1-root-snapshot8',]],
])
...
Running:[]
Stopped:['vm1']
Enadbled:['vm1-root-snapshot2', 'volume1-snapshot3', 'vm1-snapshot6', 'vm1-root-snapshot7']
attached:[]
Detached:['volume1', 'volume2', 'volume3']
Deleted:['vm1-snapshot5', 'vm1-root-snapshot1', 'vm1-root-snapshot4', 'vm1-root-snapshot8']
Expunged:[]
Ha:[]
Group:
