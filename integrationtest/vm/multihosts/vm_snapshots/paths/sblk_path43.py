...
def path():
    ...
    return dict(initial_formation="template5", checking_point=8, path_list=[
		...
		[TestAction.batch_delete_volume_snapshot, ['volume2-snapshot6','volume1-snapshot1',]],
...
Running:['vm1']
Stopped:[]
Enadbled:['volume2-snapshot1', 'volume3-snapshot1', 'vm1-root-snapshot5', 'vm1-snapshot11', 'volume1-snapshot11', 'volume2-snapshot11', 'volume3-snapshot11', 'vm1-root-backup1']
attached:['volume1', 'volume2', 'volume3']
Detached:[]
Deleted:['volume2-snapshot6', 'volume1-snapshot1', 'vm1-snapshot1', 'vm1-snapshot7', 'volume1-snapshot7', 'volume2-snapshot7', 'volume3-snapshot7']
Expunged:[]
Ha:[]
Group:
