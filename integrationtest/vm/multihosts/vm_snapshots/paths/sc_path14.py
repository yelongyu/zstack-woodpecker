...
def path():
    ...
    return dict(initial_formation="template5", path_list=[
		...
		[TestAction.use_volume_snapshot, 'volume3-snapshot9'],
		[TestAction.stop_vm, 'vm1'],
		[TestAction.use_volume_snapshot, 'vm1-root-snapshot2'],
		[TestAction.start_vm, 'vm1'],
		[TestAction.reboot_vm, 'vm1'],
		[TestAction.batch_delete_volume_snapshot, ['vm1-root-snapshot8','vm1-root-snapshot3',]],
		[TestAction.batch_delete_volume_snapshot, ['vm1-snapshot7','vm1-root-snapshot5',]],
...
Running:['vm1']
Stopped:[]
Enadbled:['vm1-snapshot1', 'vm1-root-snapshot2', 'vm1-snapshot6', 'volume3-snapshot9']
attached:[]
Detached:['volume1', 'volume2', 'volume3']
Deleted:['vm1-root-snapshot8', 'vm1-root-snapshot3', 'vm1-snapshot7', 'vm1-root-snapshot5', 'vm1-root-snapshot4']
Expunged:[]
Ha:[]
Group:
	vm_snap2:['vm1-snapshot6']---vm1
