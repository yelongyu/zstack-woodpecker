...
def path():
    ...
    return dict(initial_formation="template5", path_list=[
		...
		[TestAction.create_volume_snapshot, 'volume3', 'volume3-snapshot19'],
		[TestAction.create_volume_snapshot, 'volume1', 'volume1-snapshot20'],
...
Running:['vm1']
Stopped:[]
Enadbled:['vm1-snapshot1', 'volume2-snapshot1', 'vm1-snapshot5', 'volume2-snapshot5', 'volume3-snapshot5', 'volume3-snapshot9', 'vm1-snapshot10', 'volume1-snapshot10', 'volume2-snapshot10', 'volume3-snapshot10', 'vm1-snapshot14', 'volume1-snapshot14', 'volume2-snapshot14', 'volume3-snapshot14', 'volume3-snapshot18', 'volume3-snapshot19', 'volume1-snapshot20', 'vm1-snapshot21', 'volume1-snapshot21', 'volume2-snapshot21', 'volume3-snapshot21']
attached:['volume1', 'volume2', 'volume3']
Detached:[]
Deleted:['volume1-snapshot1', 'volume1-snapshot5', 'volume3-snapshot1']
Expunged:[]
Ha:[]
Group:
