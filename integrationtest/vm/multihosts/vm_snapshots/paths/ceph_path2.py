...
def path():
    ...
    return dict(initial_formation="template5", checking_point=8, path_list=[
		...
		[TestAction.detach_volume, 'clone@volume1'],
		...
		[TestAction.attach_volume, 'vm2', 'clone@volume1'],
		[TestAction.create_volume_backup, 'clone@volume1', 'clone@volume1-backup1'],
		[TestAction.stop_vm, 'vm2'],
		[TestAction.use_volume_backup, 'clone@volume1-backup1'],
...
Running:['vm1', 'vm2']
Stopped:[]
Enadbled:['vm1-snapshot5', 'volume1-snapshot5', 'volume2-snapshot5', 'volume3-snapshot5', 'vm1-snapshot9', 'volume1-snapshot9', 'volume2-snapshot9', 'volume3-snapshot9', 'vm2-root-snapshot13', 'clone@volume1-backup1', 'vm1-image1']
attached:['volume1', 'volume2', 'volume3', 'clone@volume2', 'clone@volume3']
Detached:['clone@volume1']
