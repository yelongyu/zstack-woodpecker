...
def path():
    ...
    return dict(initial_formation="template5", checking_point=8, path_list=[
		...
		[TestAction.batch_delete_volume_snapshot, ['volume3-snapshot12','volume3-snapshot11',]],
])
...
Running:['vm1']
Stopped:[]
Enadbled:['vm1-root-snapshot1', 'vm1-snapshot2', 'volume1-snapshot2', 'vm1-root-snapshot6', 'vm1-snapshot7', 'volume1-snapshot7', 'volume2-snapshot7', 'volume3-snapshot7', 'vm1-snapshot12', 'volume1-snapshot12', 'volume2-snapshot12', 'vm1-snapshot16', 'volume1-snapshot16', 'volume2-snapshot16', 'volume3-snapshot16']
attached:['volume1', 'volume2', 'volume3']
Detached:[]
Deleted:['volume2-snapshot2', 'volume3-snapshot2', 'volume3-snapshot12', 'volume3-snapshot11']
Expunged:[]
Ha:[]
Group:
