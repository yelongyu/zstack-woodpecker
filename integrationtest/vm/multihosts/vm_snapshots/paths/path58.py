...
def path():
    ...
    return dict(initial_formation="template5", path_list=[
		...
		[TestAction.batch_delete_snapshots, ['vm1-snapshot7','volume1-snapshot19',]],
...
Running:['vm1']
Stopped:[]
Enadbled:['vm1-root-snapshot1', 'vm1-root-snapshot2', 'volume1-snapshot7', 'volume2-snapshot7', 'volume3-snapshot7', 'volume1-snapshot11', 'volume2-snapshot11', 'volume3-snapshot11', 'vm1-snapshot15', 'volume1-snapshot15', 'volume2-snapshot15', 'volume3-snapshot15', 'vm1-snapshot19', 'volume2-snapshot19', 'volume3-snapshot19']
attached:['volume1', 'volume2', 'volume3']
Detached:[]
Deleted:['vm1-snapshot7', 'volume1-snapshot19', 'vm1-snapshot11', 'vm1-snapshot3', 'volume1-snapshot3', 'volume2-snapshot3', 'volume3-snapshot3']
Expunged:[]
Ha:[]
Group:
