...
def path():
    ...
    return dict(initial_formation="template5", path_list=[
		...
		[TestAction.create_data_vol_template_from_volume, 'volume5', 'volume5-image1'],
...
Running:['vm1', 'vm2', 'vm3']
Stopped:[]
Enadbled:['vm1-snapshot5', 'volume1-snapshot5', 'volume2-snapshot5', 'volume3-snapshot5', 'vm1-snapshot9', 'volume1-snapshot9', 'volume2-snapshot9', 'volume3-snapshot9', 'vm1-backup1', 'volume1-backup1', 'volume2-backup1', 'volume3-backup1', 'volume5-image1']
