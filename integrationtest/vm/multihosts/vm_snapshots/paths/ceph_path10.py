...
Running:['vm2']
Stopped:['vm1']
Enadbled:['vm1-snapshot5', 'volume3-snapshot5', 'vm1-root-backup1']
attached:['volume2', 'volume3', 'volume4', 'volume5']
Detached:['volume1']
Deleted:['vm1-snapshot1', 'volume1-snapshot1', 'volume2-snapshot1', 'volume3-snapshot1', 'volume2-snapshot5', 'vm1-snapshot8', 'volume2-snapshot8', 'volume3-snapshot8']
Expunged:[]
Ha:[]
Group:
'''