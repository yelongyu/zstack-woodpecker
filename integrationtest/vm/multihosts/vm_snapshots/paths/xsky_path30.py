...
Running:['vm2']
Stopped:['vm1']
Enadbled:['vm1-snapshot1', 'volume1-snapshot1', 'volume3-snapshot1', 'vm1-snapshot5', 'volume1-snapshot5', 'volume3-backup1']
attached:['volume1', 'volume3']
Detached:['volume2']
Deleted:['volume2-snapshot1', 'volume3-snapshot5', 'vm1-snapshot8', 'volume1-snapshot8', 'volume3-snapshot8']
Expunged:[]
Ha:[]
Group:
'''