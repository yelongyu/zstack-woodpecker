...
Running:[]
Stopped:['vm1']
Enadbled:['vm1-root-snapshot2', 'vm1-snapshot3', 'vm1-root-snapshot5', 'vm1-snapshot6', 'volume1-snapshot7', 'vm1-snapshot9']
attached:[]
Detached:['volume1', 'volume2', 'volume3']
Deleted:['vm1-snapshot8', 'vm1-root-snapshot4', 'volume1-snapshot1']
Expunged:[]
Ha:[]
Group:
	vm_snap2:['vm1-snapshot6']---vm1
	vm_snap1:['vm1-snapshot3']---vm1
	vm_snap4:['vm1-snapshot9']---vm1
'''