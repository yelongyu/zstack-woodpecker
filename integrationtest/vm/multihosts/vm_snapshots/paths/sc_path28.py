...
def path():
    ...
    return dict(initial_formation="template5", checking_point=8, path_list=[
		...
		[TestAction.batch_delete_volume_snapshot, ['volume3-snapshot13','volume3-snapshot4',]],
...
Running:['vm1']
Stopped:[]
Enadbled:['volume2-snapshot2', 'volume2-snapshot3', 'vm1-snapshot4', 'volume1-snapshot4', 'volume2-snapshot4', 'vm1-root-snapshot8', 'vm1-snapshot13', 'volume1-snapshot13', 'volume2-snapshot13', 'volume2-snapshot17']
attached:['volume1', 'volume2', 'volume3']
Detached:[]
Deleted:['volume2-snapshot1', 'volume3-snapshot13', 'volume3-snapshot4', 'vm1-snapshot9', 'volume1-snapshot9', 'volume2-snapshot9', 'volume3-snapshot9']
Expunged:[]
Ha:[]
Group:
'''
