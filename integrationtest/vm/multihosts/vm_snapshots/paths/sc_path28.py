...
def path():
    ...
    return dict(initial_formation="template5", path_list=[
		...
		[TestAction.batch_delete_volume_snapshot, ['volume1-snapshot2','volume1-snapshot8',]],
...
Running:['vm1']
Stopped:[]
Enadbled:['volume1-snapshot3', 'vm1-root-snapshot5', 'vm1-snapshot6', 'vm1-snapshot7']
attached:[]
Detached:['volume1', 'volume2', 'volume3']
Deleted:['volume1-snapshot1', 'volume1-snapshot2', 'volume1-snapshot8', 'vm1-snapshot4']
Expunged:[]
Ha:[]
Group:
