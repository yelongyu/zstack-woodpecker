...
def path():
    ...
    return dict(initial_formation="template5", path_list=[
		...
		[TestAction.batch_delete_volume_snapshot, ['volume1-snapshot2','volume2-snapshot1',]],
...
Running:[]
Stopped:['vm1']
Enadbled:['volume1-snapshot4', 'vm1-root-snapshot5', 'vm1-root-snapshot6', 'volume3-snapshot7', 'vm1-root-snapshot8', 'volume1-snapshot9']
attached:[]
Detached:['volume1', 'volume2', 'volume3']
Deleted:['volume1-snapshot2', 'volume2-snapshot1', 'vm1-snapshot10', 'volume3-snapshot3']
Expunged:[]
Ha:[]
Group:
'''