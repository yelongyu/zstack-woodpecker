...
def path():
    ...
    return dict(initial_formation="template5", path_list=[
		...
		[TestAction.create_data_vol_template_from_volume, 'volume5', 'volume5-image2'],
...
Running:['vm2', 'vm1']
Stopped:[]
Enadbled:['vm1-root-snapshot5', 'vm1-snapshot6', 'volume1-snapshot6', 'volume2-snapshot6', 'volume3-snapshot6', 'vm2-snapshot10', 'volume4-snapshot10', 'volume5-snapshot10', 'volume6-snapshot10', 'vm2-root-backup1', 'volume2-image1', 'volume5-image2']
