...
def path():
    ...
    return dict(initial_formation="template5", path_list=[
		...
		[TestAction.create_data_vol_template_from_volume, 'volume6', 'volume6-image2'],
...
Running:['vm2', 'vm1']
Stopped:[]
Enadbled:['vm1-snapshot1', 'volume1-snapshot1', 'volume2-snapshot1', 'volume3-snapshot1', 'vm1-root-snapshot5', 'vm1-snapshot6', 'volume1-snapshot6', 'volume2-snapshot6', 'volume3-snapshot6', 'vm1-root-backup1', 'volume1-image1', 'volume6-image2']
