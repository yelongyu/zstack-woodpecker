...
def path():
    ...
    return dict(initial_formation="template5", checking_point=8, path_list=[
		...
		[TestAction.resize_data_volume, 'clone@volume3', 5*1024*1024],
...
Running:['vm1', 'vm2']
Stopped:[]
Enadbled:['volume3-snapshot5', 'vm1-snapshot6', 'volume1-snapshot6', 'volume2-snapshot6', 'volume3-snapshot6', 'vm1-snapshot10', 'volume1-snapshot10', 'volume2-snapshot10', 'volume3-snapshot10', 'vm1-backup1', 'volume1-backup1', 'volume2-backup1', 'volume3-backup1', 'vm1-root-backup5']
