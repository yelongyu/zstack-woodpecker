...
def path():
    ...
    return dict(initial_formation="template5", checking_point=8, path_list=[
		...
		[TestAction.create_volume_snapshot, 'volume2', 'volume2-snapshot18'],
		...
		[TestAction.batch_delete_volume_snapshot, ['volume2-snapshot6','volume3-snapshot14',]],
...
Running:['vm1']
Stopped:[]
Enadbled:['vm1-root-snapshot1', 'vm1-snapshot6', 'volume1-snapshot6', 'volume3-snapshot6', 'vm1-snapshot14', 'volume1-snapshot14', 'volume2-snapshot14', 'volume2-snapshot18', 'vm1-root-snapshot19', 'vm1-snapshot20', 'volume1-snapshot20', 'volume2-snapshot20', 'volume3-snapshot20', 'vm1-backup1', 'volume1-backup1', 'volume2-backup1', 'volume3-backup1']
attached:['volume1', 'volume2', 'volume3']
Detached:[]
Deleted:['volume2-snapshot6', 'volume3-snapshot14', 'vm1-snapshot2', 'volume1-snapshot2', 'volume2-snapshot2', 'volume3-snapshot2', 'vm1-snapshot10', 'volume1-snapshot10', 'volume2-snapshot10', 'volume3-snapshot10']
Expunged:[]
Ha:[]
Group:
