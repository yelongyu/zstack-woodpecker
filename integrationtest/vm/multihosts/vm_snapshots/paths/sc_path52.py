...
Running:['vm1']
Stopped:[]
Enadbled:['vm1-snapshot2', 'volume1-snapshot2', 'volume3-snapshot2', 'vm1-snapshot6', 'volume1-snapshot6', 'volume2-snapshot6', 'volume3-snapshot6']
attached:['volume1', 'volume2', 'volume3']
Detached:[]
Deleted:['volume1-snapshot1', 'volume2-snapshot2']
Expunged:[]
Ha:[]
Group:
