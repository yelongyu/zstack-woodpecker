...
Running:['vm1']
Stopped:[]
Enadbled:['vm1-root-snapshot1', 'vm1-snapshot3', 'volume2-snapshot5', 'vm1-snapshot6', 'volume3-snapshot7', 'vm1-snapshot8']
attached:[]
Detached:['volume1', 'volume2', 'volume3']
Deleted:['volume1-snapshot4', 'vm1-snapshot2', 'vm1-root-snapshot9']
Expunged:[]
Ha:[]
Group:
