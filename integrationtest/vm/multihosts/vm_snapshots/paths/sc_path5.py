...
def path():
    ...
    return dict(initial_formation="template5", path_list=[
		...
		[TestAction.batch_delete_volume_snapshot, ['vm1-snapshot4','volume3-snapshot10',]],
])
...
Running:['vm1']
Stopped:[]
Enadbled:['volume2-snapshot2', 'vm1-root-snapshot3', 'volume2-snapshot4', 'volume3-snapshot4', 'vm1-root-snapshot8', 'volume2-snapshot9', 'vm1-snapshot10', 'volume1-snapshot10', 'volume2-snapshot10', 'vm1-root-snapshot14', 'vm1-snapshot15', 'volume1-snapshot15', 'volume2-snapshot15', 'volume3-snapshot15']
attached:['volume1', 'volume2', 'volume3']
Detached:[]
Deleted:['volume2-snapshot1', 'volume1-snapshot4', 'vm1-snapshot4', 'volume3-snapshot10']
Expunged:[]
Ha:[]
Group:
	vm_snap3:['vm1-snapshot15', 'volume1-snapshot15', 'volume2-snapshot15', 'volume3-snapshot15']---vm1volume1_volume2_volume3
'''