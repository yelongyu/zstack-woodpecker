...
case_flavor = dict(path1=           dict(initial_formation=templateContent, path_list=[[TestAction.stop_vm, "vm1"], [TestAction.start_vm, "vm1"], [TestAction.delete_volume, "vm1-volume1"], [TestAction.create_image_from_volume, "vm1", "image1"], [TestAction.resize_volume, "vm1", 5*1024*1024], [TestAction.detach_volume, "vm1-volume2"], [TestAction.stop_vm, "vm1"], [TestAction.reinit_vm, "vm1"], [TestAction.start_vm, "vm1"], [TestAction.resize_volume, "vm1", 5*1024*1024], [TestAction.detach_volume, "vm1-volume3"], [TestAction.stop_vm, "vm1"], [TestAction.change_vm_image, "vm1"], [TestAction.start_vm, "vm1"], [TestAction.create_data_vol_template_from_volume, "vm1-volume2", "image2"], [TestAction.reboot_vm, "vm1"]]),
		  ...
		  path24=          dict(initial_formation=templateContent2, path_list=[[TestAction.create_volume, "volume1", "=scsi"], [TestAction.attach_volume, "vm1", "volume1"], [TestAction.create_volume, "volume2", "=scsi"], [TestAction.attach_volume, "vm1", "volume2"], [TestAction.detach_volume, "volume1"], [TestAction.cleanup_ps_cache], [TestAction.attach_volume, "vm1", "volume1"], [TestAction.create_volume_backup, "volume1", "backup1"], [TestAction.delete_volume, "volume1"], [TestAction.cleanup_ps_cache], [TestAction.create_data_template_from_backup, "backup1", "image1"], [TestAction.create_data_volume_from_image, "volume3", "image1", "=scsi"], [TestAction.delete_volume, "volume3"], [TestAction.create_volume_snapshot, "vm1-root", "snapshot1"], [TestAction.create_volume_backup, "volume2", "backup2"], [TestAction.reboot_vm, "vm1"]]),
                  ...
                  path27=           dict(initial_formation=templateContent3, path_list=[[TestAction.create_volume, "volume2"], [TestAction.create_volume, "volume3"], [TestAction.delete_volume, "vm1-volume1"], [TestAction.create_volume_snapshot, "vm1-root", "snapshot1"], [TestAction.attach_volume, "vm1", "volume2"], [TestAction.create_volume_backup, "volume2", "backup1"], [TestAction.detach_volume, "volume2"], [TestAction.clone_vm, "vm1", "vm2", "=full"], [TestAction.resize_data_volume, "volume2", 5*1024*1024], [TestAction.delete_volume, "volume3"], [TestAction.stop_vm, "vm1"], [TestAction.use_volume_snapshot, "snapshot1"], [TestAction.start_vm, "vm1"], [TestAction.attach_volume, "vm1", "volume2"], [TestAction.stop_vm, "vm1"], [TestAction.use_volume_backup, "backup1"], [TestAction.reboot_vm, "vm1"]]),
                  ...
                  path35=           dict(initial_formation=templateContent2, path_list=[[TestAction.create_data_volume_from_image, "volume1", "=scsi,shareable"], [TestAction.create_data_volume_from_image, "volume2", "=scsi,shareable"], [TestAction.create_data_volume_from_image, "volume3", "=scsi,shareable"], [TestAction.create_data_volume_from_image, "volume4", "=scsi,shareable"], [TestAction.create_data_volume_from_image, "volume5", "=scsi,shareable"], [TestAction.create_data_volume_from_image, "volume6", "=scsi,shareable"], [TestAction.create_data_volume_from_image, "volume7", "=scsi,shareable"], [TestAction.create_data_volume_from_image, "volume8", "=scsi,shareable"], [TestAction.attach_volume, "vm1", "volume1"], [TestAction.attach_volume, "vm1", "volume2"], [TestAction.attach_volume, "vm1", "volume3"], [TestAction.attach_volume, "vm1", "volume4"], [TestAction.attach_volume, "vm1", "volume5"], [TestAction.attach_volume, "vm1", "volume6"], [TestAction.attach_volume, "vm1", "volume7"], [TestAction.attach_volume, "vm1", "volume8"], [TestAction.delete_volume, "volume1"], [TestAction.clone_vm, "vm1", "vm2"], [TestAction.create_volume_backup, "volume2", "backup1"], [TestAction.detach_volume, "volume3"], [TestAction.create_volume_snapshot, "vm1-root", "snapshot1"], [TestAction.use_volume_backup, "backup1"], [TestAction.delete_volume, "volume2"], [TestAction.create_image_from_volume, "vm1", "image1"], [TestAction.create_data_vol_template_from_volume, "volume3", "image2"], [TestAction.reboot_vm, "vm1"]]),
		  ...
		  path46=           dict(initial_formation=templateContent2, path_list=[[TestAction.create_volume, "volume1"], [TestAction.attach_volume, "vm1", "volume1"], [TestAction.create_volume, "volume2"], [TestAction.delete_volume, "volume1"], [TestAction.reboot_vm, "vm1"], [TestAction.create_vm_backup, "vm1", "backup1"], [TestAction.attach_volume, "vm1", "volume2"], [TestAction.stop_vm, "vm1"], [TestAction.change_vm_image, "vm1"], [TestAction.stop_vm, "vm1"], [TestAction.use_vm_backup, "backup1"], [TestAction.delete_volume, "volume2"], [TestAction.reinit_vm, "vm1"], [TestAction.start_vm, "vm1"], [TestAction.create_volume_snapshot, "vm1-root", "snapshot1"], [TestAction.reboot_vm, "vm1"]]),
                  ...
                  path48=          dict(initial_formation=templateContent2, path_list=[[TestAction.create_volume, "volume1", "=scsi"], [TestAction.attach_volume, "vm1", "volume1"], [TestAction.create_volume, "volume2", "=scsi"], [TestAction.attach_volume, "vm1", "volume2"], [TestAction.create_volume, "volume3", "=scsi"], [TestAction.attach_volume, "vm1", "volume3"], [TestAction.create_volume, "volume4", "=scsi"], [TestAction.attach_volume, "vm1", "volume4"], [TestAction.create_volume, "volume5", "=scsi"], [TestAction.attach_volume, "vm1", "volume5"], [TestAction.create_volume, "volume6", "=scsi"], [TestAction.attach_volume, "vm1", "volume6"], [TestAction.create_volume, "volume7", "=scsi"], [TestAction.attach_volume, "vm1", "volume7"], [TestAction.create_volume, "volume8", "=scsi"], [TestAction.attach_volume, "vm1", "volume8"], [TestAction.delete_volume, "volume1"], [TestAction.change_vm_image, "vm1"], [TestAction.create_image_from_volume, "vm1", "image1"], [TestAction.delete_volume, "volume2"], [], [TestAction.detach_volume, "volume3"], [TestAction.detach_volume, "volume4"], [TestAction.detach_volume, "volume5"], [TestAction.detach_volume, "volume6"], [TestAction.detach_volume, "volume7"], [TestAction.detach_volume, "volume8"], [TestAction.ps_migrate_volume, "vm1-root"], [TestAction.ps_migrate_volume, "volume3"], [TestAction.attach_volume, "vm1", "volume3"], [TestAction.detach_volume, "volume3"], [TestAction.clone_vm, "vm1", "vm2"], [TestAction.create_volume_snapshot, "volume3", "snapshot1"], [TestAction.reboot_vm, "vm1"]]),
                  path49=          dict(initial_formation=templateContent2, path_list=[[TestAction.create_volume, "volume1"], [TestAction.attach_volume, "vm1", "volume1"], [TestAction.create_volume, "volume2"], [TestAction.attach_volume, "vm1", "volume2"], [TestAction.create_volume, "volume3"], [TestAction.create_volume, "volume4"], [TestAction.attach_volume, "vm1", "volume4"], [TestAction.create_volume, "volume5"], [TestAction.attach_volume, "vm1", "volume5"], [TestAction.create_volume, "volume6"], [TestAction.attach_volume, "vm1", "volume6"], [TestAction.create_volume, "volume7"], [TestAction.attach_volume, "vm1", "volume7"], [TestAction.create_volume, "volume8"], [TestAction.detach_volume, "volume1"], [TestAction.cleanup_ps_cache], [TestAction.create_volume_backup, "volume5", "backup1"], [TestAction.detach_volume, "volume2"], [TestAction.create_image_from_volume, "vm1", "image1"], [TestAction.resize_volume, "vm1", 5*1024*1024], [TestAction.delete_volume, "volume3"], [TestAction.detach_volume, "volume4"],  [TestAction.detach_volume, "volume5"],  [TestAction.detach_volume, "volume6"],  [TestAction.detach_volume, "volume7"], [TestAction.stop_vm, "vm1"], [TestAction.ps_migrate_volume, "vm1-root"], [TestAction.ps_migrate_volume, "volume5"], [TestAction.attach_volume, "vm1", "volume5"], [TestAction.use_volume_backup, "backup1"], [TestAction.start_vm, "vm1"], [TestAction.reboot_vm, "vm1"]]),
                  path50=           dict(initial_formation=templateContent2, path_list=[[TestAction.create_data_volume_from_image, "volume1", "=scsi,shareable"], [TestAction.create_data_volume_from_image, "volume2", "=scsi,shareable"], [TestAction.create_data_volume_from_image, "volume3", "=scsi,shareable"], [TestAction.create_data_volume_from_image, "volume4", "=scsi,shareable"], [TestAction.create_data_volume_from_image, "volume5", "=scsi,shareable"], [TestAction.create_data_volume_from_image, "volume6", "=scsi,shareable"], [TestAction.create_data_volume_from_image, "volume7", "=scsi,shareable"], [TestAction.create_data_volume_from_image, "volume8", "=scsi,shareable"], [TestAction.attach_volume, "vm1", "volume1"], [TestAction.attach_volume, "vm1", "volume2"], [TestAction.attach_volume, "vm1", "volume3"], [TestAction.attach_volume, "vm1", "volume4"], [TestAction.attach_volume, "vm1", "volume5"], [TestAction.attach_volume, "vm1", "volume6"], [TestAction.attach_volume, "vm1", "volume7"], [TestAction.attach_volume, "vm1", "volume8"], [TestAction.detach_volume, "volume1"], [TestAction.cleanup_ps_cache], [TestAction.create_volume_snapshot, "volume1", "snapshot1"], [TestAction.attach_volume, "vm1", "volume1"], [TestAction.detach_volume, "volume1"], [TestAction.detach_volume, "volume2"], [TestAction.detach_volume, "volume3"], [TestAction.detach_volume, "volume4"], [TestAction.detach_volume, "volume5"], [TestAction.detach_volume, "volume6"], [TestAction.detach_volume, "volume7"], [TestAction.detach_volume, "volume8"], [TestAction.ps_migrate_volume, "vm1-root"], [TestAction.use_volume_snapshot, "snapshot1"], [TestAction.delete_volume, "vouem1"], [TestAction.change_vm_image, "vm1"], [TestAction.ps_migrate_volume, "volume8"], [TestAction.reboot_vm, "vm1"]]),
                  path52=           dict(initial_formation=templateContent2, path_list=[[TestAction.create_volume, "volume1", "=scsi,shareable"], [TestAction.create_volume, "volume2", "=scsi,shareable"], [TestAction.detach_volume, "volume1"], [TestAction.create_image_from_volume, "vm1", "image1"], [TestAction.create_data_vol_template_from_volume, "volume1", "image2"], [TestAction.attach_volume, "vm1", "volume2"], [TestAction.cleanup_ps_cache], [TestAction.ps_migrate_volume, "volume1"], [TestAction.delete_volume, "volume1"], [TestAction.reinit_vm, "vm1"], [TestAction.create_data_vol_template_from_volume, "volume2", "image2"], [TestAction.reboot_vm, "vm1"]]),
                  path53=           dict(initial_formation=templateContent2, path_list=[[TestAction.create_data_volume_from_image, "volume1"], [TestAction.create_data_volume_from_image, "volume2"], [TestAction.create_data_volume_from_image, "volume3"], [TestAction.create_data_volume_from_image, "volume4"], [TestAction.create_data_volume_from_image, "volume5"], [TestAction.create_data_volume_from_image, "volume6"], [TestAction.create_data_volume_from_image, "volume7"], [TestAction.create_data_volume_from_image, "volume8"], [TestAction.attach_volume, "vm1", "volume1"], [TestAction.attach_volume, "vm1", "volume2"], [TestAction.attach_volume, "vm1", "volume3"], [TestAction.attach_volume, "vm1", "volume4"], [TestAction.attach_volume, "vm1", "volume5"], [TestAction.attach_volume, "vm1", "volume6"], [TestAction.attach_volume, "vm1", "volume7"], [TestAction.attach_volume, "vm1", "volume8"], [TestAction.detach_volume, "volume1"], [TestAction.create_image_from_volume, "vm1", "image1"], [TestAction.ps_migrate_volume, "volume1"], [TestAction.migrate_vm, "vm1"],  [TestAction.attach_volume, "vm1", "volume1"], [TestAction.create_vm_backup, "vm1", "backup1"], [TestAction.delete_volume, "volume7"], [TestAction.detach_volume, "volume2"], [TestAction.detach_volume, "volume3"], [TestAction.detach_volume, "volume4"], [TestAction.detach_volume, "volume5"], [TestAction.detach_volume, "volume6"], [TestAction.detach_volume, "volume8"], [TestAction.stop_vm, "vm1"], [TestAction.ps_migrate_volume, "vm1-root"], [TestAction.create_data_vol_template_from_volume, "volume8", "image2"], [TestAction.reboot_vm, "vm1"]]),\
		path163=dict(initial_formation=templateContent2, path_list=[[TestAction.create_volume, "volume1","=scsi,shareable"], [TestAction.attach_volume, "vm1", "volume1"], [TestAction.create_volume_snapshot, "vm1-root", "snapshot1"], [TestAction.create_volume_backup, "volume1"], [TestAction.delete_volume, "volume1"], [TestAction.use_volume_snapshot, "snapshot1"], [TestAction.create_volume, "volume2", "=scsi,shareable"], [TestAction.create_volume_snapshot, "volume2", 'snapshot2'], [TestAction.delete_volume, "volume2"], [TestAction.create_image_from_volume, "vm1", "image1"], [TestAction.create_volume, "volume3", "=scsi,shareable"], [TestAction.create_volume_snapshot, "volume3", "snapshot3"], [TestAction.use_volume_snapshot, "snapshot3"], [TestAction.reboot_vm, "vm1"]]))
