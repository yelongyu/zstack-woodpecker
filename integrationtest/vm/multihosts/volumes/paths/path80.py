...
def path():
	...
	[TestAction.create_volume_snapshot, "volume8", 'snapshot2'],
	[TestAction.create_volume_snapshot, "volume8", 'snapshot3'],
	[TestAction.create_volume_snapshot, "volume8", 'snapshot4'],
	[TestAction.create_volume_snapshot, "volume8", 'snapshot5'],
	[TestAction.create_volume_snapshot, "volume8", 'snapshot6'],
	[TestAction.delete_volume, "volume9"],
	[TestAction.clone_vm, "vm1", "vm2", "full"],
	[TestAction.create_volume, "volume10", "=scsi"],
	[TestAction.attach_volume, "vm1", "volume10"],
        [TestAction.batch_delete_volume_snapshot, ["snapshot3","snapshot5","snapshot6"]],
	...
	[TestAction.create_volume_snapshot, "volume10", 'snapshot7'],
