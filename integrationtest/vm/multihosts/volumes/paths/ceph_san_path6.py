    ...
    if san_ps and ceph_ps:
        return dict(initial_formation="template3",
                    path_list=[[TestAction.create_volume, "ceph_volume1", "=ps_uuid::%s" % ceph_ps[0]],
                               ...
                               [TestAction.create_volume_snapshot, san_vms[2].name + '-root', san_vms[2].name + '-sp2'],
                               ...
                               [TestAction.delete_vm, san_vms[0].cloned_name_list[3]],
                               [TestAction.reinit_vm, san_vms[0].cloned_name_list[4]],
                               ceph_vms[-1].clone(5),
                               [TestAction.delete_vm, ceph_vms[-1].cloned_name_list[0]],
                               [TestAction.delete_vm, ceph_vms[-1].cloned_name_list[1]],
                               [TestAction.delete_vm, ceph_vms[-1].cloned_name_list[2]],
                               [TestAction.delete_vm, ceph_vms[-1].cloned_name_list[3]],
                               [TestAction.reinit_vm, ceph_vms[-1].cloned_name_list[4]],
                               [TestAction.reinit_vm, san_vms[-1].name],
                               [TestAction.reinit_vm, ceph_vms[-1].name],
                               ])
    else:
