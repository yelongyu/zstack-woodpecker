...
The test is specific for nfs and local pss scenario
@author: SyZhao
'''
...
def test():
    ...
    cond = res_ops.gen_query_conditions('type', '=', inventory.NFS_PRIMARY_STORAGE_TYPE)
    vm_creation_option.set_ps_uuid(res_ops.query_resource(res_ops.PRIMARY_STORAGE, cond)[0].uuid)
