'''
@Integration Test
@Scenario: management network and storage network separation for ceph
...
def test():
    ...
    if not test_stub.ensure_vm_not_on(vm.get_vm().uuid, vm.get_vm().hostUuid, vr_hosts+mn_hosts):
