'''
New Integration Test for KVM VM ha with VR on the same host never stop mode.
@author: SyZhao
'''
...
#    l2_network_interface = os.environ.get('l2ManagementNetworkInterface')
    ...
    cmd = "ifconfig %s down && sleep 240 && ifconfig %s up" % (l2_network_interface, l2_network_interface)
