'''
New Integration Test for KVM VM, located in MN host, force stop and start host check vm status
Notice that there is no MN HA, considering poweroff scenario, the MN should be self-started
after the host is started.
@author: SyZhao
'''
