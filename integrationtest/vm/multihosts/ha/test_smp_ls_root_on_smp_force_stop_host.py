...
The test is specific for smp and local pss scenario
@author: SyZhao
'''
...
def test():
    ...
    vm_creation_option.set_ps_uuid(res_ops.get_resource(res_ops.PRIMARY_STORAGE, type="SharedMountPoint")[0].uuid)
