...
def test():
    ...
    image_option.set_url("http://172.20.1.15:7480/iso/CentOS-x86_64-7.2-Minimal.iso")
    ...
    # image_option.set_mediaType('ISO')
    image_option.set_url("http://172.20.1.15:7480/diskimages/core-image-minimal-qemux86-64_v1.qcow2")
    image_option.set_backup_storage_uuid_list([bss[0].uuid])
    image_option.set_timeout(60000)
    image=img_ops.add_image(image_option)
    ...
    # image_option.set_mediaType('ISO')
    image_option.set_url("http://172.20.1.15:7480/diskimages/zstack_image_test.raw")
    image_option.set_backup_storage_uuid_list([bss[0].uuid])
    image_option.set_timeout(60000)
    image=img_ops.add_image(image_option)
    ...
    # image_option.set_mediaType('ISO')
    image_option.set_url("http://172.20.1.15:7480/diskimages/zstack-image-1.2-flat.vmdk")
    image_option.set_backup_storage_uuid_list([bss[0].uuid])
    image_option.set_timeout(60000)
    image=img_ops.add_image(image_option)
