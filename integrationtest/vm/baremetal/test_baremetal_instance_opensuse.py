...
def test():
   ...
   #Hack inspect ks file to support vbmc, include ipmi device logic and ipmi addr to 127.0.0.1
    ...
    img_option.set_url(os.environ.get('imageServer')+"/iso/openSUSE-Leap-15.0-DVD-x86_64.iso")
...
<profile xmlns="http://www.suse.com/1.0/yast2ns" xmlns:config="http://www.suse.com/1.0/configns">
    <configure>
        ...
        <scripts>
            ...
            <post-scripts config:type="list">
                <script>
                    <filename>zstack_post_install.sh</filename>
                    <source> <![CDATA[
                    #!bin/sh
    ...
    <install>
        <general>
            <mode>
                <confirm config:type="boolean">{{ FORCE_INSTALL }}</confirm>
