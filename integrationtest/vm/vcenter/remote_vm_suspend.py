'''
suspend vm via remote mevoco api
@author: SyZhao
'''
...
#this script is design for suspending the vm named "vm-crt-via-rmt-mevoco"
def test():
    ...
    test_util.test_pass("suspend vm-crt-via-rmt-mevoco passed.")
