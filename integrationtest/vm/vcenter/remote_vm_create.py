'''
create vm via remote mevoco api
@author: SyZhao
'''
...
#this script is designed to run on remote mevoco
def test():
    ...
    vm = test_stub.create_vm_in_vcenter(vm_name = 'vm-crt-via-rmt-mevoco', image_name = "MicroCore-Linux.ova", l3_name = "L3-251-net1")
    vm.check()

    vct_ops.delete_vcenter(vcenter_uuid)
    test_util.test_pass("creating vm via remote mevoco api passed.")
