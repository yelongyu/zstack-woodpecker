'''
resume vm via remote mevoco api
@author: SyZhao
'''
...
#this script is design for resuming the vm named "vm-crt-via-rmt-mevoco"
def test():
    ...
    test_util.test_pass("resume vm-crt-via-rmt-mevoco passed.")
