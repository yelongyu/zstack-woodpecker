'''
test for vm deleting in newly add vcenter
@author: SyZhao
'''
...
def test():
    ...
    vm = test_stub.create_vm_in_vcenter(vm_name = 'vm-delete-test', image_name = sync_image_name, l3_name = network_pattern1)
    vm.check()
    ...
    test_util.test_pass("vm deleting of vcenter test passed.")
