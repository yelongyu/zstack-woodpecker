'''
start vm via remote mevoco api
@author: SyZhao
'''
...
#this script is design for starting the vm named "vm-crt-via-rmt-mevoco"
def test():
    ...
    test_util.test_pass("start vm-crt-via-rmt-mevoco passed.")
