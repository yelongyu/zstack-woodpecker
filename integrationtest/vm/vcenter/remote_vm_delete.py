'''
delete vm via remote mevoco api
@author: SyZhao
'''
...
#this script is design for deleting the vm named "vm-crt-via-rmt-mevoco"
def test():
    ...
    test_util.test_pass("Deleting vm-crt-via-rmt-mevoco passed.")
