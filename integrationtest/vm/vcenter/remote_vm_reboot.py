'''
reboot vm via remote mevoco api
@author: SyZhao
'''
...
#this script is design for rebooting the vm named "vm-crt-via-rmt-mevoco"
def test():
    ...
    test_util.test_pass("rebooting vm-crt-via-rmt-mevoco passed.")
