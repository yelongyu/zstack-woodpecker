...
def test():
    ...
    vm = test_stub.create_vm(vm_name = 'ckvmoffering-u13-64', image_name = "imageName_i_u13", instance_offering_uuid=new_offering.uuid)
    ...
    assert available_memory_before == available_memory_after + MEMchange / int(test_lib.lib_get_provision_memory_rate())
    ...
    assert vm_interal_mem_before == vm_internal_mem_after - MEMchange/1024/1024
