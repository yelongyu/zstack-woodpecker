...
New Integration Test for bs capacity when expunge added image.
...
def test():
    ...
    delete_policy = test_lib.lib_set_delete_policy('image', 'Delay')
    ...
    if avail_cap > (avail_cap3 + 1024000) or avail_cap < avail_cap3:
    ...
    test_util.test_pass('Test backup storage capacity for adding/expunging image pass.')
