...
def test():
    ...
    pool = ps_ops.add_ceph_primary_storage_pool(ps.uuid, 'woodpecker_7', isCreate=True)
    ...
    volume_creation_option.set_system_tags(['ceph::pool::woodpecker_7', 'ephemeral::shareable', 'capability::virtio-scsi'])
    ...
    vm.destroy()
    vm.check()
    test_util.test_pass('Create Shareable Data Volume on ceph pool and attach to stopped VM Test Success')
