...
def test():
    ...
    if "test-config-vyos-nfs.xml" in os.environ.get('WOODPECKER_TEST_CONFIG_FILE'):
        config_json = os.environ.get('configJson_2nets')
    elif "test-config-vyos-flat-dhcp-nfs-sep-pub-man.xml" in os.environ.get('WOODPECKER_TEST_CONFIG_FILE'):
        config_json = os.environ.get('configJsonPubMan')
    elif "test-config-vyos-flat-dhcp-nfs-mul-net-pubs.xml" in os.environ.get('WOODPECKER_TEST_CONFIG_FILE'):
