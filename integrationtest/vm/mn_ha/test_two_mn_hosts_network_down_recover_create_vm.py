...
Integration Test for creating KVM VM in MN HA mode with two random mn hosts network down and recovery.
...
def test():
    ...
    test_util.test_logger("wait for 40 seconds to see if management node VM starts on any host")
    time.sleep(40)
    try:
