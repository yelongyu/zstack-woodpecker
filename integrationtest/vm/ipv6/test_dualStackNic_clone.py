...
def test():
    ...
    vm1_nic1 = vm1.get_vm().vmNics[0].usedIps[0].ip
    vm1_nic2 = vm1.get_vm().vmNics[0].usedIps[1].ip
    vm2_nic1 = res_ops.query_resource(res_ops.VM_INSTANCE)[1].vmNics[0].usedIps[0].ip
    vm2_nic2 = res_ops.query_resource(res_ops.VM_INSTANCE)[1].vmNics[0].usedIps[1].ip
