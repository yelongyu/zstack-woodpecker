...
def test():
    ...
    net_ops.add_nic_to_security_group(sg1.security_group.uuid, [vm1_nic_uuid])
    net_ops.add_nic_to_security_group(sg2.security_group.uuid, [vm2_nic_uuid])
    ...
    try:
        test_lib.lib_open_vm_listen_ports(vm1.vm, Port.ports_range_dict['rule1_ports'], l3_uuid, vm1_ipv4, target_ipv6 = vm1_ipv6)
        test_lib.lib_open_vm_listen_ports(vm2.vm, Port.ports_range_dict['rule1_ports'], l3_uuid, vm2_ipv4, target_ipv6 = vm2_ipv6)
