...
New Integration Test for License addons disaster-recovery.
...
def test():
    ...
    test_util.test_logger('load and check addon license disaster-recovery with 2 day ')
    file_path = test_stub.gen_addons_license('woodpecker', 'woodpecker@zstack.io', '2', 'Addon', '', '', 'disaster-recovery')
    node_uuid = res_ops.query_resource(res_ops.MANAGEMENT_NODE)[0].uuid
    ...
    test_util.test_pass('Check License for disaster-recovery Test Success')
