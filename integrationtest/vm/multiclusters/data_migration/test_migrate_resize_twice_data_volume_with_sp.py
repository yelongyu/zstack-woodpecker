...
def test():
    ...
    new_size2 = 3*1024*1024*1024
    data_migration.resize_data_volume(new_size2)
    ...
    data_migration.check_vol_sp(data_migration.data_volume.get_volume().uuid, 5)
...
#     data_migration.del_obsoleted_data_volume()
    ...
    test_util.test_pass('Resize data volume and Create Snapshot of Migrate Data Volume Test Success')
