...
def test():
    ...
    image_name = os.environ.get('imageNameBase_223_mn')
    ...
    test_util.test_logger('Upgrade zstack by latest iso') 
    test_stub.upgrade_by_iso(vm_ip, tmp_file, iso_path, upgrade_script_path)
