'''
Test the upgrade master from 2.3.0.301 install -r /home/testzstack and ugrade by repo server to master
@author: YeTian  2019-08-10
'''
import os
import tempfile
import uuid
...
def test():
    ...
    target_file = '/root/zstack_3.0.0.bin'
