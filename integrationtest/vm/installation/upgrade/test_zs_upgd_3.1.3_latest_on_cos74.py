'''
Test the upgrade master from 3.1.3.11
@author: YeTian  2018-12-27
'''
import os
import tempfile
import uuid
...
def test():
    ...
    image_name = os.environ.get('imageNameBase_313_mn_c74')
    ...
    test_util.test_pass('ZStack 3.1.3 to master upgrade Test Success')
