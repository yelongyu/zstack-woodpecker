'''
Test the upgrade master from 3.5.0.188
...
def test():
    ...
    image_name = os.environ.get('imageNameBase_350_mn_c74')
    ...
    test_util.test_pass('ZStack 3.5.0.188 to master upgrade Test Success')
