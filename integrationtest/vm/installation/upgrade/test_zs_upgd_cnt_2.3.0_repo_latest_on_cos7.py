'''
cnt upgrade from  '2.3.1','2.3.2','2.4.0','2.5.0' upgrade 2.6 bug http://jira.zstack.io/browse/ZSTAC-16775 and lastest version
...
def test():
    ...
    test_util.test_pass('ZStack cnt upgrade 2.4.0 2.5.0 Test Success')
