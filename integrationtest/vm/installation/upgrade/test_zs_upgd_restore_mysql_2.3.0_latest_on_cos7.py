...
def test():
    ...
    image_name = os.environ.get('imageNameBase_230_restore_mysql_mn')
    ...
    test_util.test_pass('ZStack upgrade 2.3.0 to the latest 2.3.0 to the latest restore_mysql Test Success')
