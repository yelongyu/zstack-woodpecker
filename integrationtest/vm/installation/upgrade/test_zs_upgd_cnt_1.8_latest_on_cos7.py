...
# + image_name
    ...
    test_util.test_dsc('mount the nfs server in vm') 
    ...
    release_ver=['1.9','1.10','2.0.0','2.1.0','2.2.0','2.3.0','2.3.1','2.3.2','2.4.0','2.5.0','2.6.0','3.0.0','3.0.1','3.1.0','3.1.3','3.2.0','3.3.0','3.4.0','3.5.0.1','3.5.2']
