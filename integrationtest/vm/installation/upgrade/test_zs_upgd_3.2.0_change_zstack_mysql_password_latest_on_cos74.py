'''
Test the upgrade master from 3.2.0.497 change zstack mysql password 
@author: YeTian  2019-03-09
'''
import os
import tempfile
import uuid
...
def test():
    ...
    test_stub.change_mysql_password(vm_ip, tmp_file)
    ...
    test_util.test_pass('ZStack 3.2.0 to master upgrade Test Success')
