'''
@author: YeTian
Test install management node with centos7.2 image and upgrade zstack iso and add the host
'''
import os
import tempfile
import uuid
...
#    #vm_name = 'zs_install_test_centos72_%s' % image.name
...
def test():
    ...
    image_name = os.environ.get('imageNameBase_c72')
