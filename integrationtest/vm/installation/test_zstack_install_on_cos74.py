'''
@author: YeTian
Test install management node with centos7.4 and  add the host
'''
import os
import tempfile
import uuid
...
#    #vm_name = 'zs_install_test_centos74_%s' % image.name
...
def test():
    ...
    #image = sce_ops.query_resource(zstack_management_ip, res_ops.IMAGE, conditions).inventories[0]
    #vm_inv = create_vm(image)
    image_name = os.environ.get('imageNameBase_c74_231_ex')
