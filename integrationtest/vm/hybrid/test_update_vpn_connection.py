...
def test():
    ...
    hybrid.update_vpn_connection(name='Vpc-Vpn-Connection')
    hybrid.update_vpn_connection(description='test-Vpc-Vpn-Connection')

    test_util.test_pass('Update Vpc Vpn Connection Test Success')
