...
class zstack_kvm_sg_db_exist_checker(sg_common_checker):
    '''check kvm sg existence in database. If it is in db, 
        return self.judge(True). If not, return self.judge(False)'''
    def __init__(self):
        super(zstack_kvm_sg_db_exist_checker, self).__init__()
...
#class zstack_kvm_sg_rule_db_exist_checker(sg_common_checker):
#    '''check kvm sg rule existence in database. If it is in db, 
#        return self.judge(True). If not, return self.judge(False)'''
#    def __init__(self):
#        #Target nic_uuid for test. 
#        super(zstack_kvm_sg_db_exist_checker, self).__init__()
...
class zstack_kvm_sg_tcp_ingress_exist_checker(sg_common_checker):
    def __init__(self):
        super(zstack_kvm_sg_tcp_ingress_exist_checker, self).__init__()
...
class zstack_kvm_sg_tcp_egress_exist_checker(sg_common_checker):
    def __init__(self):
        super(zstack_kvm_sg_tcp_egress_exist_checker, self).__init__()

    def check(self):
        test_util.test_dsc('Check TCP egress rules iptable state')
        super(zstack_kvm_sg_tcp_egress_exist_checker, self).check()
        test_result = True
        if self.nic_uuid:
            test_vm = test_lib.lib_get_vm_by_nic(self.nic_uuid)
        else:
...
class zstack_kvm_sg_icmp_ingress_exist_checker(sg_common_checker):
    def __init__(self):
        super(zstack_kvm_sg_icmp_ingress_exist_checker, self).__init__()

    def check(self):
        test_util.test_dsc('Check ICMP ingress rules iptable state')
        super(zstack_kvm_sg_icmp_ingress_exist_checker, self).check()
        test_result = True
        if self.nic_uuid:
            test_vm = test_lib.lib_get_vm_by_nic(self.nic_uuid)
        else:
...
class zstack_kvm_sg_icmp_egress_exist_checker(sg_common_checker):
    def __init__(self):
        super(zstack_kvm_sg_icmp_egress_exist_checker, self).__init__()
...
class zstack_kvm_sg_tcp_egress_checker(sg_common_checker):
    '''check kvm security group tcp egress connection.  
    ...
    '''
    def __init__(self):
        super(zstack_kvm_sg_tcp_egress_checker, self).__init__()

    def check(self):
        super(zstack_kvm_sg_tcp_egress_checker, self).check()
...
class zstack_kvm_sg_tcp_ingress_checker(sg_common_checker):
    '''check kvm security group tcp ingress connection. ''' 
    def __init__(self):
        super(zstack_kvm_sg_tcp_ingress_checker, self).__init__()
...
class zstack_kvm_sg_tcp_internal_vms_checker(sg_common_checker):
    ...
    '''
    def __init__(self):
        super(zstack_kvm_sg_tcp_internal_vms_checker, self).__init__()
...
class zstack_kvm_sg_udp_ingress_checker(sg_common_checker):
    '''check kvm security group udp ingress rule. 
    The main checking will be check if rule is there.
    ''' 
    def __init__(self):
        super(zstack_kvm_sg_udp_ingress_checker, self).__init__()

    def check(self):
        super(zstack_kvm_sg_udp_ingress_checker, self).check()
...
class zstack_kvm_sg_udp_egress_checker(sg_common_checker):
    '''check kvm security group udp egress rule. 
    The main checking will be check if rule is there.
    ''' 
    def __init__(self):
        super(zstack_kvm_sg_udp_egress_checker, self).__init__()
...
class zstack_kvm_sg_icmp_ingress_checker(sg_common_checker):
    '''check kvm security group icmp ingress rule. 
    ''' 
    def __init__(self):
        super(zstack_kvm_sg_icmp_ingress_checker, self).__init__()
...
class zstack_kvm_sg_icmp_egress_checker(sg_common_checker):
    '''check kvm security group icmp egress rule. 
    ''' 
    def __init__(self):
        super(zstack_kvm_sg_icmp_egress_checker, self).__init__()

    def check(self):
        super(zstack_kvm_sg_icmp_egress_checker, self).check()
        test_result = True
...
class zstack_kvm_sg_icmp_internal_vms_checker(sg_common_checker):
    '''
    check kvm security group icmp rule between attached VMs. 
    Only check the icmp ingress rules. If ingress rule is not set, there isn't
    any icmp can reach vm.
    ''' 
    def __init__(self):
        super(zstack_kvm_sg_icmp_internal_vms_checker, self).__init__()
